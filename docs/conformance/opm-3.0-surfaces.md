...
| --- | --- | --- |
| Strict KVN/XML parse and validation | Covered | Python tests parse both notations, reject semantic and syntactic violations, expose aggregate validation, and verify structured exception attributes. |
