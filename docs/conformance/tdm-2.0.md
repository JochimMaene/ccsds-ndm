...
| Shared surfaces | `library::parsing` and `library::output`, `conformance::generation`, Python API tests, and the family benchmark matrices exercise shared parsing, generation, diagnostics, and dispatch. |
