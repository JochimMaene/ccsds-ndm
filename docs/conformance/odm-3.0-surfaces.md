...
validation, generation, conversion, and diagnostics to the verified Rust core
...
| File behavior | Covered | Focused tests exercise file parsing and atomic output replacement. |
