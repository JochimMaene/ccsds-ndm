...
| String, file, and dispatch surfaces | Covered | `opm::conversion` covers string conversion; `message_output_contract` covers typed/type-erased output and atomic file replacement for AEM, OEM, and OPM alike. Parse/generation diagnostic suites cover invalid source, sink, and resource failures. |
