...
pub fn tdm_observation(input: &mut &str) -> KvnResult<TdmObservation> {
    ...
    let (epoch, data) = dispatch! {
        preceded(ws, keyword);
        "ANGLE_1" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Angle1(v)))),
        "ANGLE_2" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Angle2(v)))),
        "CARRIER_POWER" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::CarrierPower(v)))),
        "CLOCK_BIAS" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ClockBias(v)))),
        "CLOCK_DRIFT" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ClockDrift(v)))),
        "DOPPLER_COUNT" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::DopplerCount(v)))),
        "DOPPLER_INSTANTANEOUS" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::DopplerInstantaneous(v)))),
        "DOPPLER_INTEGRATED" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::DopplerIntegrated(v)))),
        "DOR" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Dor(v)))),
        "MAG" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Mag(v)))),
        "PC_N0" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::PcN0(v)))),
        "PR_N0" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::PrN0(v)))),
        "PRESSURE" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Pressure(v)))),
        "RANGE" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Range(v)))),
        "RCS" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Rcs(v)))),
        "RECEIVE_FREQ" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq(v)))),
        "RECEIVE_FREQ_1" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq1(v)))),
        "RECEIVE_FREQ_2" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq2(v)))),
        "RECEIVE_FREQ_3" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq3(v)))),
        "RECEIVE_FREQ_4" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq4(v)))),
        "RECEIVE_FREQ_5" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::ReceiveFreq5(v)))),
        ...
        "RHUMIDITY" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| {
            Percentage::new(v, None).map(|p| (e, TdmObservationData::Rhumidity(p)))
        }),
        "STEC" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Stec(v)))),
        "TEMPERATURE" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::Temperature(v)))),
        "TRANSMIT_FREQ_1" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreq1(v)))),
        "TRANSMIT_FREQ_2" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreq2(v)))),
        "TRANSMIT_FREQ_3" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreq3(v)))),
        "TRANSMIT_FREQ_4" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreq4(v)))),
        "TRANSMIT_FREQ_5" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreq5(v)))),
        "TRANSMIT_FREQ_RATE_1" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreqRate1(v)))),
        "TRANSMIT_FREQ_RATE_2" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreqRate2(v)))),
        "TRANSMIT_FREQ_RATE_3" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreqRate3(v)))),
        "TRANSMIT_FREQ_RATE_4" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreqRate4(v)))),
        "TRANSMIT_FREQ_RATE_5" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TransmitFreqRate5(v)))),
        ...
        "TROPO_DRY" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TropoDry(v)))),
        "TROPO_WET" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::TropoWet(v)))),
        "VLBI_DELAY" => (kv_sep, kv_epoch_token, preceded(ws, float::<&str, f64, ErrMode<CcsdsNdmError>>)).map(|(_, e, v)| Ok((e, TdmObservationData::VlbiDelay(v)))),
